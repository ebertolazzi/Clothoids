...
print_version (void) {
  ...
  luai_writeline();
  l_message(progname, "MechatroniX INTerpreter, (C) Bertolazzi, Biral, Bosetti 2013");
}
...
collectargs (char **argv, int *args) {
  ...
  for (i = 1; argv[i] != NULL; i++) {
    ...
    switch (argv[i][1]) {  /* option */
      ...
      case 'm':  /* both options need an argument */
