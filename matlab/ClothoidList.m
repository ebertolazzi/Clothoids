classdef ClothoidList < CurveBase
  ...
  methods
    ...
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function [ icurve, x, y, s, t, iflag, dst ] = ...
      closestPointInRange( self, qx, qy, ibegin, iend, varargin )
      [ icurve, x, y, s, t, iflag, dst ] = ...
         ClothoidListMexWrapper( 'closestPointInRange', self.objectHandle, ...
           qx, qy, ibegin, iend, varargin{:} ...
         );
    end
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    function [ icurve, x, y, s, t, iflag, dst ] = ...
      closestPointInSRange( self, qx, qy, s_begin, s_end, varargin )
      [ icurve, x, y, s, t, iflag, dst ] = ...
         ClothoidListMexWrapper( 'closestPointInSRange', self.objectHandle, ...
