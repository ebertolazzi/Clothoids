...
"\n" \
"  PolyLineMexWrapper( 'changeOrigin', OBJ, x0, y0 );\n" \
"  PolyLineMexWrapper( 'translate', OBJ, tx, ty );\n" \
"  PolyLineMexWrapper( 'trim', OBJ, smin, smax );\n" \
...
"  res = PolyLineMexWrapper( 'theta',  OBJ );\n" \
"  res = PolyLineMexWrapper( 'sMin', OBJ );\n" \
"  res = PolyLineMexWrapper( 'sMmax', OBJ );\n" \
...
"\n" \
"  nurbs = PolyLineMexWrapper( 'to_nurbs', OBJ );\n" \
"  [s,t] = PolyLineMexWrapper( 'findST', OBJ, x, y );\n" \
"\n" \
"%==========================================================================%\n" \
"%                                                                          %\n" \
