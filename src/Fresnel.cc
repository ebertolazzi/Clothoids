...
namespace G2lib {
  ...
  */
  ...
  void
  ClothoidData::tg_DD( real_type   s,
                       real_type & tx_DD,
  ...
  void
  ClothoidData::tg_DDD( real_type   s,
                        real_type & tx_DDD,
  ...
  void
  ClothoidData::evaluate( real_type   s,
                          real_type & theta,
                          real_type & kappa,
                          real_type & x,
                          real_type & y ) const {
