...
[ x1, y1, s1, t1, iflag1, dst1 ] = S.closest_point( x0, y0 );
%[ x, y, s, t, iflag, dst ] = S.closest_point_in_s_range( PNT(1), PNT(2), s_begin, s_end );
hold on;
%[x1,y1] = S.eval( s );
...
res1 = S1.closest_point( x0, y0 );
res2 = S.closest_point_in_s_range( x0, y0, s_min, s_max );
