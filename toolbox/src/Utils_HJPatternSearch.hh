...
namespace Utils {
  ...
  //!
  //!  The `HJPatternSearch` class provides an implementation of the Hooke-Jeeves
  //!  Pattern Search Algorithm, which is a direct search method for optimization problems.
  //!  This method does not require the computation of gradients and is suitable for
  //!  minimizing functions in arbitrary dimensions.
  //!
  //!  \tparam Real The data type used for the optimization (e.g., float, double).
  //!
  //!  ## References
  //!
  //!  The implementation is based on the following references:
  //!
  //!  - R. Hooke, T. A. Jeeves, "Direct Search" Solution of Numerical and Statistical Problems,
  //!    Westinghouse Research Laboratories, Pittsburgh, Pennsylvania.
  //!
  //!  - Arthur Kaupe, "Algorithm 178: Direct Search," Communications of the ACM,
  //!    Volume 6, Number 6, June 1963, page 313.
  //!
  //!  - M. Bell, Malcolm Pike, "Remark on Algorithm 178: Direct Search,"
  //!    Communications of the ACM, Volume 9, Number 9, September 1966, page 684.
  //!
  //!  - F.K. Tomlin, L.B. Smith, "Remark on Algorithm 178: Direct Search,"
  //!    Communications of the ACM, Volume 12, Number 11, November 1969, pages 637-638.
  //!
  //!
  ...
  //!
  //!  In your main function, define your initial guess and the step size for the search.
  //!  Then call the do_solve function with your defined objective function.
  //!
  //!  \code{cpp}
  //!  int main() {
  ...
  private:
    ...
    { ++m_fun_evaluation; return m_fun( x.data() ); }
  ...
  public:
    ...
    //!
    //! \param level The verbosity level (0: none, 1: basic info, 2: detailed info).
    //!
    ...
    //!
    //! \brief Prints the current state information to the specified output stream.
    //!
    ...
    //!
    //! \brief Runs the optimization algorithm starting from the provided solution.
    //!
