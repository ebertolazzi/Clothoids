...
namespace Utils
{
  ...
  //!
  //! \class Trichotomy
  //! \brief Class for minimize the function \f$ f(x) \f$ without the usew of
  //! derivative
  //!
  ...
  //!       [link](https://doi.org/10.48550/arXiv.1903.07117)
  //!
  //! **Usage Example**
  //!
  ...
  public:
    ...
    //!
    //! Find the minimum of a function wrapped in the class
    //! `Trichotomy_base_fun<Real>` starting from guess interval `[a,b]`
    //!
    //! \param a    lower bound search interval
    //! \param b    upper bound search interval
    //! \param fun  the pointer to base class `Trichotomy_base_fun<Real>`
    ...
    //! \param a    lower bound search interval
    //! \param b    upper bound search interval
    //! \param pfun the pointer to base class `Trichotomy_base_fun<Real>`
    //! wrapping the user function
    //!
    ...
    //!
    //! Find the minimum of a function wrapped in the class
    //! `Trichotomy_base_fun<Real>` starting from guess interval
    //! `[x-delta,x+delta]`
    //!
