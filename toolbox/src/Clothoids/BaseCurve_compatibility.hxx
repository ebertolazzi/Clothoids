...
//!
real_type length( real_type offs ) const
{
...
//!
void bbox( real_type offs, real_type & xmin, real_type & ymin, real_type & xmax, real_type & ymax ) const
{
  if ( G2lib::use_ISO )
    this->bbox_ISO( offs, xmin, ymin, xmax, ymax );
  else
    this->bbox_SAE( offs, xmin, ymin, xmax, ymax );
}
...
{
  if ( G2lib::use_ISO )
    this->nor_ISO( s, nx, ny );
  else
    this->nor_SAE( s, nx, ny );
}
...
{
  if ( G2lib::use_ISO )
    this->nor_ISO_D( s, nx_D, ny_D );
  else
    this->nor_SAE_D( s, nx_D, ny_D );
}
...
{
  if ( G2lib::use_ISO )
    this->nor_ISO_DD( s, nx_DD, ny_DD );
  else
    this->nor_SAE_DD( s, nx_DD, ny_DD );
}
...
{
  if ( G2lib::use_ISO )
    this->nor_ISO_DDD( s, nx_DDD, ny_DDD );
  else
    this->nor_SAE_DDD( s, nx_DDD, ny_DDD );
}
...
//!
void evaluate( real_type s, real_type offs, real_type & th, real_type & k, real_type & x, real_type & y ) const
{
  if ( G2lib::use_ISO )
    this->evaluate_ISO( s, offs, th, k, x, y );
  else
    this->evaluate_SAE( s, offs, th, k, x, y );
}

//!
//! \f$x\f$-coordinate at curvilinear coordinate \f$s\f$ with offset `offs` (ISO/SAE).
//!
real_type X( real_type s, real_type offs ) const
{
...
//!
real_type Y( real_type s, real_type offs ) const
{
...
//!
real_type X_D( real_type s, real_type offs ) const
{
...
//!
real_type Y_D( real_type s, real_type offs ) const
{
...
//!
real_type X_DD( real_type s, real_type offs ) const
{
...
//!
real_type Y_DD( real_type s, real_type offs ) const
{
...
//!
real_type X_DDD( real_type s, real_type offs ) const
{
...
//!
real_type Y_DDD( real_type s, real_type offs ) const
{
...
void eval_D( real_type s, real_type offs, real_type & x_D, real_type & y_D ) const
{
  if ( G2lib::use_ISO )
    ...
    this->eval_SAE_D( s, offs, x_D, y_D );
}
...
void eval_DD( real_type s, real_type offs, real_type & x_DD, real_type & y_DD ) const
{
  if ( G2lib::use_ISO )
    ...
    this->eval_SAE_DD( s, offs, x_DD, y_DD );
}
...
void eval_DDD( real_type s, real_type offs, real_type & x_DDD, real_type & y_DDD ) const
{
  if ( G2lib::use_ISO )
    ...
    this->eval_SAE_DDD( s, offs, x_DDD, y_DDD );
}
