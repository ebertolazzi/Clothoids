...
#define MEX_ERROR_MESSAGE                                                                      \
  ...
  "\n" MEX_INFO_MESSAGE( "ClothoidListMexWrapper" ) MEX_INFO_MESSAGE_END
...
#undef CMD
  ...
  static void do_push_back( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_push_back_G1( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_reserve( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_get_STK( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_get_XY( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_G2( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
#define CMD "ClothoidListMexWrapper('build_G2', OBJ, x, y, theta0, kappa0, theta1, kappa1): "
    ...
    real_type kappa1 = Utils::mex_get_scalar_value( arg_in_7, CMD "Error in reading `kappa1`" );

    bool ok{ ptr->build_G2( nx, x, y, theta0, kappa0, theta1, kappa1 ) };
...
#undef CMD
  ...
  static void do_build_G2_cyclic( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_G2_with_target( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_G2_cyclic_with_target( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_smooth_quasi_G2( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_raw( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_3arcG2( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_2arcG2( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_CLC( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_build_3arcG2fixed( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
#define CMD "ClothoidListMexWrapper('build_3arcG2fixed',OBJ,s0,x0,y0,theta0,kappa0,s1,x1,y1,theta1,kappa1): "
    ...
    G2solve3arc g2sol;
    int         iter = g2sol.build_fixed_length( s0, x0, y0, theta0, kappa0, s1, x1, y1, theta1, kappa1 );
    if ( iter >= 0 )
    {
      ptr->init();
      ptr->reserve( 3 );
...
#undef CMD
  ...
  static void do_build_theta( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_make_open( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_get( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_num_segments( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_deltaTheta( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_deltaKappa( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_export_table( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_export_ruby( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_closest_segment( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
#define CMD "ClothoidListMexWrapper('closest_segment',OBJ,qx,qy): "
    ...
    real_type qx = Utils::mex_get_scalar_value( arg_in_2, CMD "`qx` expected to be a real scalar" );
    real_type qy = Utils::mex_get_scalar_value( arg_in_3, CMD "`qx` expected to be a real scalar" );
...
#undef CMD
  ...
  static void do_closest_point_in_range( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
#define CMD "ClothoidListMexWrapper('closest_point_in_range',OBJ,qx,qy,[ibegin,iend],['ISO'/'SAE']): "
    ...
    if ( nrhs >= 6 )
    {
      icurve_begin = Utils::mex_get_int64( arg_in_4, CMD "`ibegin` expected to be an integer" );
      icurve_end   = Utils::mex_get_int64( arg_in_5, CMD "`iend` expected to be an integer" );
    }
    ...
    if ( ISO ) { iflag = ptr->closest_point_in_range_ISO( qx, qy, icurve_begin, icurve_end, x, y, s, t, dst, icurve ); }
    else
    {
      iflag = ptr->closest_point_in_range_SAE( qx, qy, icurve_begin, icurve_end, x, y, s, t, dst, icurve );
    }

    if ( nlhs == 1 )
    {
      static char const * fieldnames[] = { "icurve", "x", "y", "s", "t", "iflag", "dst" };

      mxArray * mx_icurve;
      Utils::mex_set_scalar_int32( mx_icurve, icurve );
      mxArray * mx_iflag;
      Utils::mex_set_scalar_int32( mx_iflag, iflag );
...
#undef CMD
  ...
  static void do_closest_point_in_s_range( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
#define CMD "ClothoidListMexWrapper('closest_point_in_s_range',OBJ,qx,qy,s_begin,s_end,['ISO'/'SAE']): "
    ...
    if ( nrhs >= 6 )
    {
      s_curve_begin = Utils::mex_get_scalar_value( arg_in_4, CMD "`s_begin` expected to be a scalar" );
      s_curve_end   = Utils::mex_get_scalar_value( arg_in_5, CMD "`s_end` expected to be a scalar" );
    }
    ...
    if ( ISO )
    {
      iflag = ptr->closest_point_in_s_range_ISO( qx, qy, s_curve_begin, s_curve_end, x, y, s, t, dst, icurve );
    }
    else
    {
      iflag = ptr->closest_point_in_s_range_SAE( qx, qy, s_curve_begin, s_curve_end, x, y, s, t, dst, icurve );
    }
...
#undef CMD
  ...
  static void do_s_to_index( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
#define CMD "ClothoidListMexWrapper('s_to_index',OBJ,s): "
    ...
    real_type s = Utils::mex_get_scalar_value( arg_in_2, CMD "`s` expected to be a real scalar" );
...
#undef CMD
  ...
  static void do_save( int nlhs, mxArray *[], int nrhs, mxArray const * prhs[] )
  {
