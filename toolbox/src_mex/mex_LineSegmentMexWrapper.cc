...
#define MEX_ERROR_MESSAGE                                                        \
  ...
  "\n" MEX_INFO_MESSAGE( "LineSegmentMexWrapper" ) MEX_INFO_MESSAGE_END
...
#define CMD "LineSegmentMexWrapper('new',x0,y0,theta0,L): "
      ...
      th0 = Utils::mex_get_scalar_value( arg_in_3, CMD "`theta0` expected to be a real scalar" );
      L   = Utils::mex_get_scalar_value( arg_in_4, CMD "`L` expected to be a real scalar" );
...
#define CMD "LineSegmentMexWrapper('build',OBJ,x0,y0,theta0,L): "
      ...
      th0 = Utils::mex_get_scalar_value( arg_in_4, CMD "`theta0` expected to be a real scalar" );
