...
#define MEX_ERROR_MESSAGE                                                                             \
  ...
  "\n" MEX_INFO_MESSAGE( "DubinsMexWrapper" ) MEX_INFO_MESSAGE_END
...
#define CMD "DubinsMexWrapper('get_pars',OBJ): "
    ...
    static char const * fieldnames[] = { "x0",     "y0",     "theta0", "x1", "y1",     "theta1",     "x2",
                                         "y2",     "theta2", "x3",     "y3", "theta3", "kappa1",     "kappa2",
                                         "kappa3", "L1",     "L2",     "L3", "L123",   "dubins_type" };
...
#undef CMD
  ...
  static void do_get_range_angles_begin( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_get_range_angles_end( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
