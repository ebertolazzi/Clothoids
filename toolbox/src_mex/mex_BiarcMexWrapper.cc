...
#define MEX_ERROR_MESSAGE                                                                       \
  ...
  "\n" MEX_INFO_MESSAGE( "BiarcMexWrapper" ) MEX_INFO_MESSAGE_END
...
#define CMD "BiarcMexWrapper('build_3P',OBJ,p0,p1,p2): "
      ...
      UTILS_MEX_ASSERT( n == 2, CMD "Error in reading length(p0) == {} expect length(p0) == 2\n", n );
      p1 = Utils::mex_vector_pointer( arg_in_3, n, CMD "Error in reading p1" );
      UTILS_MEX_ASSERT( n == 2, CMD "Error in reading length(p1) == {} expect length(p1) == 2\n", n );
      p2 = Utils::mex_vector_pointer( arg_in_4, n, CMD "Error in reading p2" );
      UTILS_MEX_ASSERT( n == 2, CMD "Error in reading length(p2) == {} expect length(p2) == 2\n", n );
...
#undef CMD
    ...
    {
      UTILS_MEX_ASSERT0( false, "BiarcMexWrapper('build_3P',OBJ,...) expected 5 or 8 arguments\n" );
    }
  }

  // . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

  static void do_x_middle( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_y_middle( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_theta_middle( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_s_middle( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_kappa0( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_kappa1( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_length0( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_length1( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
...
#undef CMD
  ...
  static void do_to_nurbs( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
    Biarc * ptr = Utils::mex_convert_mx_to_ptr<Biarc>( arg_in_1 );
