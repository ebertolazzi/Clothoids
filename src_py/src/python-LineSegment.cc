...
namespace G2lib
{
  namespace python
  {
    ...
    {
      py::class_<G2lib::LineSegment, G2lib::BaseCurve>(
        m,
        "LineSegment",
        R"S(
        ...
        .def(
          py::init<real_type, real_type, real_type, real_type>(),
          py::arg( "x0" ),
          py::arg( "y0" ),
          py::arg( "theta0" ),
          py::arg( "l" ) )
        ...
        .def(
          "build_2P",
          py::overload_cast<real_type, real_type, real_type, real_type>( &LineSegment::build_2P ),
          py::arg( "x0" ),
          py::arg( "y0" ),
          py::arg( "x1" ),
          py::arg( "y1" ),
        ...
        .def(
          "build_2P",
          []( LineSegment & self, const std::tuple<real_type, real_type> p0, const std::tuple<real_type, real_type> p1 )
          {
        ...
        .def(
          ...
          []( const LineSegment & self )
          {
            ...
            return std::make_tuple(
              ...
              std::make_tuple( std::make_tuple( Poly[0][0], Poly[0][1] ), std::make_tuple( Poly[1][0], Poly[1][1] ) ) );
          },
          R"S(
    ...
    void wrap_PolyLine( py::module & m )
    {
      py::class_<PolyLine, BaseCurve>(
        ...
        .def( py::init<CircleArc const &, real_type>(), py::arg( "c" ), py::arg( "tol" ) )
        .def( py::init<Biarc const &, real_type>(), py::arg( "b" ), py::arg( "tol" ) )
        .def( py::init<ClothoidCurve const &, real_type>(), py::arg( "b" ), py::arg( "tol" ) )
        .def( py::init<ClothoidList const &, real_type>(), py::arg( "b" ), py::arg( "tol" ) )
        ...
        .def(
          ...
          []( const PolyLine & self )
          {
            ...
            for ( integer i = 0; i < n; i++ ) { ret.push_back( std::make_tuple( x[i], y[i] ) ); }
            return ret;
          },
          R"S(
        ...
        .def(
          "init",
          py::overload_cast<>( &PolyLine::init ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<real_type, real_type>( &PolyLine::push_back ),
          py::arg( "x" ),
          py::arg( "y" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<LineSegment const &>( &PolyLine::push_back ),
          py::arg( "c" ),
          R"S(
          Pushes back another segment in the polyline via ending point
        ...
        .def(
          "push_back",
          py::overload_cast<CircleArc const &, real_type>( &PolyLine::push_back ),
          py::arg( "c" ),
          py::arg( "tol" ),
          R"S(
          Pushes back another segment in the polyline via ending point
        ...
        .def(
          "push_back",
          py::overload_cast<Biarc const &, real_type>( &PolyLine::push_back ),
          py::arg( "c" ),
          py::arg( "tol" ),
          R"S(
          Pushes back another segment in the polyline via ending point
        ...
        .def(
          "push_back",
          py::overload_cast<ClothoidCurve const &, real_type>( &PolyLine::push_back ),
          py::arg( "c" ),
          py::arg( "tol" ),
          R"S(
          Pushes back another segment in the polyline via ending point
        ...
        .def(
          "push_back",
          py::overload_cast<ClothoidList const &, real_type>( &PolyLine::push_back ),
          py::arg( "l" ),
          py::arg( "tol" ),
          R"S(
          Pushes back another segment in the polyline via ending point
        ...
        .def(
          "build",
          []( PolyLine & self, const std::vector<std::tuple<real_type, real_type>> points )
          {
        ...
        .def(
          "build",
          py::overload_cast<LineSegment const &>( &PolyLine::build ),
          py::arg( "l" ),
          R"S(
        ...
        .def(
          "build",
          py::overload_cast<CircleArc const &, real_type>( &PolyLine::build ),
          py::arg( "c" ),
          py::arg( "tol" ),
          R"S(
        ...
        .def(
          "build",
          py::overload_cast<Biarc const &, real_type>( &PolyLine::build ),
          py::arg( "b" ),
          py::arg( "tol" ),
          R"S(
        ...
        .def(
          "build",
          py::overload_cast<ClothoidCurve const &, real_type>( &PolyLine::build ),
          py::arg( "c" ),
          py::arg( "tol" ),
          R"S(
        ...
        .def(
          "build",
          py::overload_cast<ClothoidList const &, real_type>( &PolyLine::build ),
          py::arg( "cl" ),
          py::arg( "tol" ),
          R"S(
        ...
        .def(
          "build_AABBtree",
          py::overload_cast<>( &PolyLine::build_AABBtree, py::const_ ),
          R"S(
