...
namespace G2lib
{
  namespace python
  {
    void wrap_BaseCurve( py::module & m )
    {
      ...
      py::class_<BaseCurve, PythonicBaseCurve>(
        m,
        "BaseCurve",
        R"S(
        ...
        .def(
          "bbox_ISO",
          []( const BaseCurve & self, real_type offs )
          {
            real_type x_min, y_min, x_max, y_max;
        ...
        .def(
          "bb_triangles",
          []( const BaseCurve & self, real_type max_angle, real_type max_size, integer icurve )
          {
            std::vector<Triangle2D> tvec;
            self.bb_triangles( tvec, max_angle, max_size, icurve );
            return tvec;
          },
          py::arg( "max_angle" ) = Utils::m_pi / 18,
        ...
        .def(
          "bb_triangles_ISO",
          []( const BaseCurve & self, real_type offs, real_type max_angle, real_type max_size, integer icurve )
          {
            std::vector<Triangle2D> tvec;
        ...
        .def(
          "theta",
          []( const BaseCurve & self, const std::vector<real_type> & s )
          {
        ...
        .def(
          "X_ISO",
          []( const BaseCurve & self, std::vector<real_type> s, std::vector<real_type> offs )
          {
            const size_t           n = std::min( s.size(), offs.size() );
            std::vector<real_type> x( n );
            for ( size_t i = 0; i < n; i++ ) { x[i] = self.X_ISO( s[i], offs[i] ); }
            return x;
          },
          py::arg( "s" ),
          py::arg( "offs" ),
        ...
        .def(
          ...
          []( const BaseCurve & self, std::vector<real_type> s, std::vector<real_type> offs )
          {
            ...
            for ( size_t i = 0; i < n; i++ ) { y[i] = self.Y_ISO( s[i], offs[i] ); }
            return y;
          },
          py::arg( "s" ),
          py::arg( "offs" ),
        ...
        .def(
          "tg",
          []( const BaseCurve & self, real_type s )
          {
            real_type r_x, r_y;
            self.tg( s, r_x, r_y );
        ...
        .def(
          ...
          []( const BaseCurve & self, const std::vector<real_type> & s )
          {
            ...
            for ( size_t i = 0; i < n; i++ ) { self.evaluate( s[i], th[i], k[i], x[i], y[i] ); }
            return std::make_tuple( th, k, x, y );
          },
          py::arg( "s" ),
          R"S(
        ...
        .def(
          ...
          []( const BaseCurve & self, const std::vector<real_type> & s )
          {
            ...
            for ( size_t i = 0; i < n; i++ ) { self.eval( s[i], x[i], y[i] ); }
            return std::make_tuple( x, y );
          },
          py::arg( "s" ),
          R"S(
        ...
        .def(
          "evaluate_ISO",
          []( const BaseCurve & self, real_type s, real_type offs )
          {
            real_type th, k, x, y;
        ...
        .def(
          "evaluate_ISO",
          []( const BaseCurve & self, const std::vector<real_type> & s, const std::vector<real_type> & offs )
          {
            const size_t           n = std::min( s.size(), offs.size() );
            std::vector<real_type> th( n ), k( n ), x( n ), y( n );
            for ( size_t i = 0; i < n; i++ ) { self.evaluate_ISO( s[i], offs[i], th[i], k[i], x[i], y[i] ); }
            return std::make_tuple( th, k, x, y );
          },
          py::arg( "s" ),
          py::arg( "offs" ),
        ...
        .def(
          ...
          []( const BaseCurve & self, const std::vector<real_type> & s, const std::vector<real_type> & offs )
          {
            const size_t           n = std::min( s.size(), offs.size() );
            std::vector<real_type> x( n ), y( n );
            for ( size_t i = 0; i < n; i++ ) { self.eval_ISO( s[i], offs[i], x[i], y[i] ); }
            return std::make_tuple( x, y );
          },
          py::arg( "s" ),
          py::arg( "offs" ),
        ...
        **y** coordinate third derivative at curvilinear abscissa **s**
        ...
        .def(
          ...
          []( const BaseCurve & self, const std::vector<real_type> & s )
          {
            const size_t           n = s.size();
            std::vector<real_type> x( n ), y( n );
            for ( size_t i = 0; i < n; i++ ) { self.eval_D( s[i], x[i], y[i] ); }
            return std::make_tuple( x, y );
          },
          py::arg( "s" ),
          R"S(
        ...
        .def(
          ...
          []( const BaseCurve & self, const std::vector<real_type> & s )
          {
            const size_t           n = s.size();
            std::vector<real_type> x( n ), y( n );
            for ( size_t i = 0; i < n; i++ ) { self.eval_DD( s[i], x[i], y[i] ); }
            return std::make_tuple( x, y );
          },
          py::arg( "s" ),
          R"S(
        ...
        .def(
          ...
          []( const BaseCurve & self, const std::vector<real_type> & s )
          {
            const size_t           n = s.size();
            std::vector<real_type> x( n ), y( n );
            for ( size_t i = 0; i < n; i++ ) { self.eval_DDD( s[i], x[i], y[i] ); }
            return std::make_tuple( x, y );
          },
          py::arg( "s" ),
          R"S(
        ...
        **y** coordinate third derivative at curvilinear abscissa **s**, in SAE
        ...
        .def(
          "intersect",
          []( const BaseCurve & self, const BaseCurve & curve )
          {
            IntersectList ilist;
        ...
        .def(
          "closestPoint",
          []( const BaseCurve & self, real_type qx, real_type qy )
          {
            integer   ret;
        ...
        .def(
          "closestPoint",
          []( const BaseCurve & self, const std::vector<real_type> & qx, const std::vector<real_type> & qy )
          {
        ...
        .def(
          "findST",
          []( const BaseCurve & self, real_type x, real_type y )
          {
            real_type s, t;
        ...
        .def(
          "findST",
          []( const BaseCurve & self, const std::vector<real_type> & x, const std::vector<real_type> & y )
          {
            const size_t           n = std::min( x.size(), y.size() );
            std::vector<real_type> s( n ), t( n );
            std::vector<bool>      ret( n );
            for ( size_t i = 0; i < n; i++ ) { ret[i] = self.findST_ISO( x[i], y[i], s[i], t[i] ); }
            return std::make_tuple( ret, s, t );
          },
          py::arg( "x" ),
          py::arg( "y" ),
