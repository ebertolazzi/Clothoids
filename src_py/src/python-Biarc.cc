  ...
  namespace python
  {
    ...
    void wrap_BiarcList( py::module & m )
    {
      py::class_<BiarcList, BaseCurve>(
        ...
        .def(
          "push_back",
          py::overload_cast<LineSegment const &>( &BiarcList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<CircleArc const &>( &BiarcList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<Biarc const &>( &BiarcList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<PolyLine const &>( &BiarcList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back_G1",
          py::overload_cast<real_type, real_type, real_type>( &BiarcList::push_back_G1 ),
          py::arg( "x1" ),
          py::arg( "y1" ),
          py::arg( "theta1" ),
          R"S(
        ...
        .def(
          "build_G1",
          []( BiarcList & self, std::vector<real_type> x, std::vector<real_type> y )
          {
        ...
        .def(
          ...
          []( const BiarcList & self )
          {
            ...
            if ( !n )
            {
              return make_tuple( std::vector<real_type>(), std::vector<real_type>(), std::vector<real_type>() );
            }
        ...
        .def(
          "findST1",
          []( const BiarcList & self, real_type x, real_type y )
          {
            real_type s, t;
        ...
        .def(
          "findST1",
          []( const BiarcList & self, const std::vector<real_type> & x, const std::vector<real_type> & y )
          {
            const size_t           n = std::min( x.size(), y.size() );
        ...
        .def(
          "findST1",
          []( const BiarcList & self, integer ibegin, integer iend, real_type x, real_type y )
          {
            real_type s, t;
