...
namespace G2lib
{
  namespace python
  {
    ...
    {
      py::class_<ClothoidCurve, BaseCurve>(
        m,
        "ClothoidCurve",
        R"S(
        ...
        .def(
          py::init<real_type, real_type, real_type, real_type, real_type, real_type>(),
          py::arg( "x0" ),
          py::arg( "y0" ),
          py::arg( "theta0" ),
          py::arg( "k" ),
        ...
        .def(
          "build",
          py::overload_cast<real_type, real_type, real_type, real_type, real_type, real_type>( &ClothoidCurve::build ),
          py::arg( "x0" ),
          py::arg( "y0" ),
          py::arg( "theta0" ),
          py::arg( "k" ),
        ...
        .def(
          ...
          [](
            ...
            real_type                        y1,
            real_type                        theta1,
            std::tuple<real_type, real_type> L_D,
            std::tuple<real_type, real_type> k_D,
            std::tuple<real_type, real_type> dk_D,
            real_type                        tol = 1e-12 )
          {
        ...
        .def(
          "build",
          py::overload_cast<LineSegment const &>( &ClothoidCurve::build ),
          py::arg( "ls" ),
          R"S(
        ...
        .def(
          "build",
          py::overload_cast<CircleArc const &>( &ClothoidCurve::build ),
          py::arg( "ca" ),
          R"S(
        ...
        .def(
          "Pinfinity",
          []( const ClothoidCurve & self, bool plus )
          {
            real_type x, y;
        ...
        .def(
          "thetaTotalVariation",
          &ClothoidCurve::theta_total_variation,
          R"S(
        ...
        .def(
          ...
          &ClothoidCurve::curvatureTotalVariation,
          R"S(
        ...
        .def(
          "integralCurvature2",
          &ClothoidCurve::integralCurvature2,
          R"S(
        ...
        .def(
          ...
          []( const ClothoidCurve & self, real_type offs, integer npts, real_type max_angle )
          {
        ...
        .def(
          ...
          []( ClothoidCurve * self, real_type ds, integer qx, real_type qy )
          {
            real_type x, y, s;
        ...
        .def(
          "distanceBySample",
          []( const ClothoidCurve & self, real_type ds, integer qx, real_type qy )
          {
            real_type s;
        ...
        .def(
          ...
          &ClothoidCurve::changeCurvilinearOrigin,
          R"S(
    ...
    void wrap_ClothoidSplineG2( py::module & m )
    {
      py::class_<ClothoidSplineG2>( m, "ClothoidSplineG2" )
        ...
        .def(
          "build",
          []( ClothoidSplineG2 * self, std::vector<real_type> x, std::vector<real_type> y )
          {
            integer n = static_cast<integer>( std::min( x.size(), y.size() ) );
        ...
        .def(
          "objective",
          []( ClothoidSplineG2 * self, std::vector<real_type> theta )
          {
            real_type f;
      ...
      m.def(
         "buildP1",
         [](
           const std::vector<real_type> & xs,
           const std::vector<real_type> & ys,
           real_type                      theta_0,
           real_type                      theta_1 ) -> G2lib::ClothoidList
         {
        ...
        .def(
          "buildP2",
          []( const std::vector<real_type> & xs, const std::vector<real_type> & ys ) -> G2lib::ClothoidList
          {
            G2lib::ClothoidList                result;
            G2lib::Interpolation::Interpolator interpolator( xs, ys );
    ...
    {
      py::class_<ClothoidList, BaseCurve>(
        m,
        "ClothoidList",
        R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<LineSegment const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<CircleArc const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<Biarc const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<BiarcList const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        Append a biarc to the current list. The curve is transformed to
        ...
        .def(
          "push_back",
          py::overload_cast<PolyLine const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<ClothoidCurve const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<ClothoidList const &>( &ClothoidList::push_back ),
          py::arg( "c" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<real_type, real_type, real_type>( &ClothoidList::push_back ),
          py::arg( "kappa0" ),
          py::arg( "dkappa" ),
          py::arg( "l" ),
          R"S(
        ...
        .def(
          "push_back",
          py::overload_cast<real_type, real_type, real_type, real_type, real_type, real_type>(
        ...
        .def(
          "push_back_G1",
          py::overload_cast<real_type, real_type, real_type>( &ClothoidList::push_back_G1 ),
          py::arg( "x1" ),
          py::arg( "y1" ),
          py::arg( "theta1" ),
          R"S(
        ...
        .def(
          "build_G1",
          []( ClothoidList & self, const std::vector<real_type> & x, const std::vector<real_type> & y )
          {
        ...
        .def(
          ...
          [](
            ...
            const std::vector<real_type> & theta )
          {
        ...
        .def(
          ...
          [](
            ...
            real_type                      y0,
            real_type                      theta0,
            const std::vector<real_type> & s,
            const std::vector<real_type> & kappa )
          {
        ...
        .def(
          ...
          [](
            ...
            const std::vector<real_type> & s,
            const std::vector<real_type> & theta,
            const std::vector<real_type> & kappa ) { return self.build_raw( x, y, s, theta, kappa ); },
          py::arg( "x" ),
          py::arg( "y" ),
          py::arg( "s" ),
          py::arg( "theta" ),
        ...
        .def(
          "wrap_in_range",
          []( const ClothoidList & self, real_type s )
          {
        ...
        .def(
          "segment_length_ISO",
          &ClothoidList::segment_length_ISO,
          py::arg( "nseg" ),
          py::arg( "offs" ),
          R"S(
        ...
        .def(
          "segment_length_SAE",
          &ClothoidList::segment_length_SAE,
          py::arg( "nseg" ),
          py::arg( "offs" ),
          R"S(
        Returns the length of the segment at the requested index, with
        ...
        .def(
          "closestPointInRange",
          []( const ClothoidList & self, real_type qx, real_type qy, integer icurve_begin, integer icurve_end )
          {
            real_type x, y, s, t, dst;
            integer   icurve;
            integer ret = self.closest_point_in_range_ISO( qx, qy, icurve_begin, icurve_end, x, y, s, t, dst, icurve );
        ...
        .def(
          ...
          [](
            const ClothoidList &           self,
            const std::vector<real_type> & qx,
            const std::vector<real_type> & qy,
            integer                        icurve_begin,
            integer                        icurve_end )
          {
            const size_t n = std::min( qx.size(), qy.size() );
            std::vector<std::tuple<integer, real_type, real_type, real_type, real_type, real_type, integer>> data( n );
            for ( size_t i = 0; i < n; i++ )
            {
              real_type x, y, s, t, dst;
              integer   icurve;
              integer   ret =
                self.closest_point_in_range_ISO( qx[i], qy[i], icurve_begin, icurve_end, x, y, s, t, dst, icurve );
        ...
        .def(
          ...
          []( const ClothoidList & self, real_type qx, real_type qy, integer icurve_begin, integer icurve_end )
          {
            real_type x, y, s, t, dst;
            integer   icurve;
            integer ret = self.closest_point_in_range_SAE( qx, qy, icurve_begin, icurve_end, x, y, s, t, dst, icurve );
            return std::make_tuple( ret, x, y, s, t, dst, icurve );
          },
          py::arg( "qx" ),
          py::arg( "qy" ),
        ...
        .def(
          ...
          []( const ClothoidList & self, real_type qx, real_type qy, real_type s_begin, real_type s_end )
          {
            real_type x, y, s, t, dst;
            integer   icurve;
            integer   ret = self.closest_point_in_s_range_ISO( qx, qy, s_begin, s_begin, x, y, s, t, dst, icurve );
            return std::make_tuple( ret, x, y, s, t, dst, icurve );
          },
          py::arg( "qx" ),
          py::arg( "qy" ),
        ...
        .def(
            ...
            real_type                      s_end )
          {
            ...
            for ( size_t i = 0; i < n; i++ )
            {
              real_type x, y, s, t, dst;
              integer   icurve;
              integer ret = self.closest_point_in_s_range_ISO( qx[i], qy[i], s_begin, s_end, x, y, s, t, dst, icurve );
              data[i]     = std::make_tuple( ret, x, y, s, t, dst, icurve );
            }
            return data;
          },
        ...
        .def(
          ...
          []( const ClothoidList & self, real_type qx, real_type qy, real_type s_begin, real_type s_end )
          {
            real_type x, y, s, t, dst;
            integer   icurve;
            integer   ret = self.closest_point_in_s_range_SAE( qx, qy, s_begin, s_begin, x, y, s, t, dst, icurve );
            return std::make_tuple( ret, x, y, s, t, dst, icurve );
          },
          py::arg( "qx" ),
          py::arg( "qy" ),
        ...
        .def(
          ...
          py::arg( "offs" ),
          py::arg( "max_angle" ) = Utils::m_pi / 6,
          py::arg( "max_size" )  = 1e100,
          R"S(
        ...
        .def(
          ...
          []( const ClothoidList & self )
          {
            ...
            if ( !n ) { return make_tuple( std::vector<real_type>(), std::vector<real_type>() ); }
        ...
        .def(
          ...
          []( const ClothoidList & self )
          {
            ...
            if ( n - 1 ) { self.getDeltaTheta( deltaTheta.data() ); }
            return deltaTheta;
          },
          R"S(
        ...
        .def(
          ...
          []( const ClothoidList & self )
          {
            ...
            if ( n - 1 ) { self.getDeltaKappa( deltaKappa.data() ); }
            return deltaKappa;
          },
          R"S(
        ...
        .def(
          "findST1",
          []( const ClothoidList & self, real_type x, real_type y )
          {
            real_type s, t;
        ...
        .def(
          "findST1",
          []( const ClothoidList & self, const std::vector<real_type> & x, const std::vector<real_type> & y )
          {
            const size_t           n = std::min( x.size(), y.size() );
            std::vector<real_type> s( n ), t( n );
            std::vector<integer>   idx( n );
            for ( size_t i = 0; i < n; i++ ) { idx[i] = self.findST1( x[i], y[i], s[i], t[i] ); }
            return std::make_tuple( idx, s, t );
          },
          py::arg( "x" ),
          py::arg( "y" ),
        ...
        .def(
          "findST1",
          []( const ClothoidList & self, integer ibegin, integer iend, real_type x, real_type y )
          {
            real_type s, t;
        ...
        .def(
            ...
            const std::vector<real_type> & y )
          {
            ...
            std::vector<real_type> s( n ), t( n );
            std::vector<integer>   idx( n );
            for ( size_t i = 0; i < n; i++ ) { idx[i] = self.findST1( ibegin, iend, x[i], y[i], s[i], t[i] ); }
            return std::make_tuple( idx, s, t );
          },
          py::arg( "ibegin" ),
          py::arg( "iend" ),
        ...
        .def(
          "load",
          []( ClothoidList & self, const std::string & csv, real_type epsi )
          {
        ...
        .def(
          ...
          []( const ClothoidList & self )
          {
            ...
            list.reserve( n );
            for ( size_t i = 0; i < n; i++ ) { list.push_back( self.get( i ) ); }
            return list;
          },
          R"S(
