...
namespace G2lib
{
  namespace python
  {
    ...
    public:
      ...
      real_type length() const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, length ); }
      ...
      real_type theta( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, theta, s ); }
      ...
      real_type X( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, X, s ); }

      real_type Y( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, Y, s ); }
      ...
      real_type X_D( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, X_D, s ); }

      real_type X_DD( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, X_DD, s ); }

      real_type X_DDD( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, X_DDD, s ); }

      real_type Y_D( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, Y_D, s ); }

      real_type Y_DD( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, Y_DD, s ); }

      real_type Y_DDD( real_type s ) const override { PYBIND11_OVERLOAD_PURE( real_type, G2lib::BaseCurve, Y_DDD, s ); }
      ...
      void scale( real_type sc ) override { PYBIND11_OVERLOAD_PURE( void, G2lib::BaseCurve, scale, sc ); }

      void reverse() override { PYBIND11_OVERLOAD_PURE( void, G2lib::BaseCurve, reverse ); }
      ...
      {
        PYBIND11_OVERLOAD_PURE( integer, G2lib::BaseCurve, closest_point_ISO, qx, qy, x, y, s, t, dst );
      }
      ...
      integer closestPoint_ISO(
        ...
        real_type & dst ) const override
      {
        PYBIND11_OVERLOAD_PURE( integer, G2lib::BaseCurve, closest_point_ISO, qx, qy, offs, x, y, s, t, dst );
      }
      ...
      void bb_triangles( vector<Triangle2D> & tvec, real_type max_angle, real_type max_size, integer icurve )
        const override
      {
