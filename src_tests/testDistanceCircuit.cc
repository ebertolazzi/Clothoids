...
int main()
{
  try
  {
    ...
    real_type x_mid_line, y_mid_line, dir_mid_line, abscissa, curvature, width_L, width_R, elevation, banking, slope,
      upsilon, torsion;
    ...
    while ( file.good() )
    {
      ...
      fstr >> x_mid_line >> y_mid_line >> dir_mid_line >> abscissa >> curvature >> width_L >> width_R >> elevation >>
        banking >> slope >> upsilon >> torsion;
    ...
    idx               = C.closest_point_in_s_range_ISO( qx1, qy1, s_begin, s_end, x, y, s, t, dst, icurve );
